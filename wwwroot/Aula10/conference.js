$(document).ready(function () {
    ...
    function MyViewModel() {
        ...
        self.createParticipant = function () {
            ...
            participant.sex = $("#createParticipantModal input[name = exampleInputSex1]:checked").val();
            participant.amangas = $("#createParticipantModal input[name = exampleInputAmangas1]:checked").val();
        ...
        self.readParticipant = function (participant) {
            ...
            if (participant.amangas != '') {
                $("#readParticipantModal [name = exampleInputAmangas2][value=" + participant.amangas + "]").prop('checked', true);
            }
            else {
                $("#readParticipantModal [name = exampleInputAmangas2]").prop('checked', false);
            }
        ...
        self.readParticipants = function () {
            ...
            self.participants([
                { 'name': 'Rita Puta Fernandes', 'email': '', 'address': '', 'birthDate': '', 'sex': 'Male', 'amangas': 'Amangas',  'course': { 'id': '', 'name': '' } },
                { 'name': 'Marta Matias Lucas', 'email': 'marta.lucas@teste.com', 'address': '', 'birthDate': '', 'sex': '', 'amangas': 'Amangas','course': { 'id': '', 'name': '' } },
                { 'name': 'Ezreal Augusto Melo', 'email': '', 'address': 'Rua de Cima, n.º 8\nAveiro\nPORTUGAL', 'birthDate': '1998/11/17', 'sex': 'Male', 'amangas': 'Amangas','course': { 'id': '', 'name': '' } },
                { 'name': 'Mariana Castro', 'email': '', 'address': '', 'birthDate': '', 'sex': 'Female', 'amangas': 'Amangas','course': { 'id': '', 'name': '' } },
                { 'name': 'Albino Nico Armando', 'email': '', 'address': '', 'birthDate': '', 'sex': '', 'amangas': 'Amangas','course': { 'id': '', 'name': '' } },
                { 'name': 'Alexandra Fêmea Torres gêmeas', 'email': '', 'address': '', 'birthDate': '', 'sex': '', 'amangas': 'Amangas','course': { 'id': '', 'name': '' } }
            ]);
            //--- ordena a lista alfabeticamente pelo nome
            self.participants.sort(
                function (left, right) {
        ...
        self.updateParticipant = function (participant) {
            ...
            self.tmp.sex = $("#readParticipantModal input[name = exampleInputSex2]:checked").val();
            self.tmp.amangas = $("#readParticipantModal input[name = exampleInputAmangas2]:checked").val();
